...
def render_mpl_table(data, col_width=3.0, row_height=0.4, font_size=14, header_color="#40466e", row_colors=None, edge_color="w", bbox=None, header_columns=0, ax=None, **kwargs):
    if bbox is None:
        bbox = [0, 0, 1, 1]
